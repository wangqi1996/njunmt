...
class DataParallelModel(DataParallel):
    ...
    def init_decoder(self, enc_outputs, expand_size=1):
        return self.module.init_decoder(enc_outputs, expand_size=expand_size)

    def encode(self, src_seq):
        return self.module.encode(src_seq)

    def decode(self, tgt_seq, dec_states, log_probs=True, seed=0, sample_K=0):
        return self.module.decode(tgt_seq, dec_states, log_probs=log_probs, seed=seed, sample_K=sample_K)

    def reorder_dec_states(self, dec_states, new_beam_indices, beam_size):
        return self.module.reorder_dec_states(dec_states, new_beam_indices, beam_size)
